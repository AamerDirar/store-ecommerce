                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1"> {{ __('admin/header.welcome_word') }}
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('edit.profile') }}">
                                <i class="ft-user"></i> {{ __('admin/header.edit_profile') }}
                            </a>
                            <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ route('admin.logout') }}"><i class="ft-power"></i> {{ __('admin/header.sign_out') }}</a>
                        </div>
                    </li>
                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                    <li class="dropdown dropdown-user nav-item" @if (LaravelLocalization::getCurrentLocale() == $localeCode) style="display: none;"
                        @else  style="font-weight: bold;"
                        @endif>
                        <a class="dropdown-toggle nav-link dropdown-user-link" rel="alternate" hreflang="{{ $localeCode }}"
                            href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" >
                            <span class="mr-1">
                                <span class="user-name text-bold-700 language">
                                    {{ $properties['native'] }}
                                </span>
                                @if (LaravelLocalization::getCurrentLocale() != 'ar')
                                    <img loading="lazy" src="https://demo.activeitzone.com/ecommerce/public/frontend/images/icons/flags/sa.png" class="flag" style="margin-right:6px;">
                                @else
                                    <img loading="lazy" src="https://demo.activeitzone.com/ecommerce/public/frontend/images/icons/flags/en.png" class="flag" style="margin-right:6px;">
                                @endif
                            </span>
                        </a>
                    </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2">{{ __('admin/header.notification_word') }}</span>
                                </h6>
                                <span
                                    class="notification-tag badge badge-default badge-danger float-right m-0">5 {{ __('admin/header.new_word') }}</span>
                            </li>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">{{ __('admin/header.read_all_notifications') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2">{{ __('admin/header.messages_word') }}</span>
                                </h6>
                                <span
                                    class="notification-tag badge badge-default badge-warning float-right m-0">4 {{ __('admin/header.new_word') }}</span>
                            </li>
                            <li class="scrollable-container media-list w-100">
                                <a href="javascript:void(0)">
                                    <div class="media">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">{{ __('admin/header.read_all_messages') }}</a></li>
                        </ul>
                    </li>
